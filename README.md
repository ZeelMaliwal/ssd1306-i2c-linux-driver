# SSD1306 I2C Device Driver

A Linux kernel module that drives the SSD1306 OLED display over I2C, demonstrated on a Raspberry Pi 4.
...
GPL v2 — see `MODULE_LICENSE("GPL")` in the source.
